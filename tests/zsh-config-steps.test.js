...
describe("zsh-config step", () => {
  ...
  test("writeZshrc merges suitup-managed .zshrc while preserving user edits", async () => {
  ...
  test("writeZshenv merges suitup-managed .zshenv while preserving user edits", async () => {
