...
/**
 * Suitup-owned files may be full generated config files ("Generated by suitup")
 * or append-mode blocks ("# >>> suitup/..."). Either marker is enough to allow
 * additive line merging while still skipping unmarked user-owned config files.
 */
