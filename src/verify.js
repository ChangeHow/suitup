...
const CHECKS = {
  configs: [
    ...
    { path: ".config/zsh/shared/tools/_loader.zsh", label: "~/.config/zsh/shared/tools/_loader.zsh" },
    { path: ".config/zsh/shared/tools/fzf.zsh", label: "~/.config/zsh/shared/tools/fzf.zsh" },
    { path: ".config/zsh/shared/tools/runtime.zsh", label: "~/.config/zsh/shared/tools/runtime.zsh" },
    { path: ".config/zsh/shared/tools/atuin.zsh", label: "~/.config/zsh/shared/tools/atuin.zsh" },
    { path: ".config/zsh/shared/tools/bun.zsh", label: "~/.config/zsh/shared/tools/bun.zsh" },
    { path: ".config/zsh/shared/completion.zsh", label: "~/.config/zsh/shared/completion.zsh" },
    { path: ".config/zsh/shared/highlighting.zsh", label: "~/.config/zsh/shared/highlighting.zsh" },
    { path: ".config/zsh/shared/plugins.zsh", label: "~/.config/zsh/shared/plugins.zsh" },
